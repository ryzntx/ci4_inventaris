...
class DataInventaris extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('pages/operator/data-inventaris/index', $data);
    }
    ...
    public function tambah()
    {
        ...
        return view('pages/operator/data-inventaris/tambah', $data);
    }
    ...
    public function edit($id_inventaris)
    {
        ...
        return view('pages/operator/data-inventaris/edit', $data);
    }
