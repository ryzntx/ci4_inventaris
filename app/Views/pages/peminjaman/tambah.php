            ...
            <div class="card mt-4">
                ...
                <form action="/peminjaman/tambah" method="post">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-sm">Buat Peminjaman</button>
                    </div>
                    <?php endif; ?>
                </form>
            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" class="btn btn-primary btn-sm" id="tambahBarang"
                                                data-bs-toggle="modal" data-bs-target="#modalTambahBarang"
                                                data-id="<?= $inventaris->id_inventaris; ?>"
                                                data-kode="<?= $inventaris->kode_inventaris; ?>"
                                                data-nama="<?= $inventaris->nama; ?>">Tambah</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div
                                ...
                                <a href="<?= base_url('peminjaman/hapus-keranjang') ?>" class="btn btn-danger btn-sm"
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $item['jumlah']; ?></td>
                                        <td>
                                            <a href="/peminjaman/hapus-item-keranjang/<?= $item['row_id']; ?>"
...
<div class="modal fade" id="modalTambahBarang" tabindex="-1" aria-labelledby="modalTambahBarangLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/peminjaman/tambah-item-keranjang" method="post">
