...
-- Date: Tue, 28 May 2024 13:10:11 +0000
...
-- Dumped table `detail_peminjamans` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `inventaris` VALUES (1,'INVT121312','Meja','Sonic','Meja Belajar','Baik',13,343000,'Dana',NULL,1,0);
/*!40000 ALTER TABLE `inventaris` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `inventaris` with 1 row(s)
--
...
-- Dumped table `peminjamans` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `ruangans` VALUES (1,'Ruangan 11',NULL);
/*!40000 ALTER TABLE `ruangans` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `ruangans` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `users` VALUES (1,'Asep H','aseph','aseph@gmail.com','$2y$10$Fq.A1iLlCkHQvwkfDeB34OreLLHpU93TifeIdNjJb6XM1hl2TIlYa',NULL,'Aktif',1),(2,'Athalal','athalal','athalal@gmail.com','$2y$10$vIvkppG4OxY8oQlFE00GNet9dLf/LpMV15yu6GmfezHVh4pbN.H4e',NULL,'Aktif',3);
...
-- Dump completed on: Tue, 28 May 2024 13:10:11 +0000
